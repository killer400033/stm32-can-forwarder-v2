...
#ifndef PB_FORWARDER_PB_PB_H_INCLUDED
#define PB_FORWARDER_PB_PB_H_INCLUDED
#include <pb.h>
...
typedef PB_BYTES_ARRAY_T(8) CanFrame_can_data_t;
typedef struct _CanFrame {
    uint32_t can_id;
    uint64_t timestamp;
    CanFrame_can_data_t can_data;
    uint32_t can_bus;
} CanFrame;
...
X(a, STATIC,   SINGULAR, BYTES,    can_data,          3) \
...
#define CanFrame_size                            33
#define FORWARDER_PB_PB_H_MAX_SIZE               CanFrame_size
